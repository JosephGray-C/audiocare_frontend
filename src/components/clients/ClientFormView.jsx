...
export default function ClientFormView({ client = null, onSaved }) {
    ...
    async function handleSubmit(e) {
        ...
        const payload = {
            ...
            lastName1: formData.type === "PRIVATE" ? formData.lastName1.trim() || null : null,
            lastName2: formData.type === "PRIVATE" ? formData.lastName2.trim() || null : null,
            type: formData.type,
        ...
        <div className='w-full'>
            <div className='max-w-4xl mx-auto space-y-5'>
                <ModulePanelHeader
                    ...
                    subtitle={
                        isEdit ? "Actualice la información del cliente seleccionado" : "Complete los datos para registrar un nuevo cliente"
                    }
                    icon={Users}
                    variant='form'
                />
                ...
                <form id='clientForm' onSubmit={handleSubmit} className='space-y-5'>
                    <div className='bg-white rounded-2xl border border-slate-200 shadow-sm p-5 lg:p-6 space-y-4'>
                        <h2 className='text-sm font-semibold text-slate-700 uppercase tracking-wider'>Datos del cliente</h2>
                    ...
                    <div className='bg-white rounded-2xl border border-slate-200 shadow-sm p-5 lg:p-6 space-y-4'>
                        <h2 className='text-sm font-semibold text-slate-700 uppercase tracking-wider'>Contacto (opcional)</h2>

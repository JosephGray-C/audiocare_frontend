...
const MODULES = [
  ...
  },
  {
    ...
    readKey: "supplierOrderRead",
    crudKey: "supplierOrderCru",
    crudLabel: "CRU",
  },
  {
    key: "product",
    ...
    <div className="w-full">
      <div className="max-w-5xl mx-auto space-y-5">
        <ModulePanelHeader
          ...
          subtitle={
            adminName || "Seleccione un administrador para gestionar permisos"
          }
          icon={Shield}
          variant="form"
        />
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 lg:p-6 space-y-4">
          ...
          <div className="space-y-1">
            {MODULES.map((module) => {
              ...
              const readMessage = readLocked
                ? "Activo por escritura"
                : readOn
                  ? "Desactivar lectura"
                  : "Activar lectura";
              const crudMessage = crudOn
                ? `Desactivar ${module.crudLabel}`
                : `Activar ${module.crudLabel}`;
                  ...
                  <div className="flex justify-center">
                    <AppToolTip message={readMessage} position="top">
                      <button
                        ...
                        onClick={() =>
                          !readLocked &&
                          toggleRead(module.readKey, module.crudKey)
                        }
                        disabled={readLocked}
                    ...
                    {module.crudKey ? (
                      <AppToolTip message={crudMessage} position="top">
                        <button
                          type="button"
                          onClick={() =>
                            toggleCrud(module.readKey, module.crudKey)
                          }

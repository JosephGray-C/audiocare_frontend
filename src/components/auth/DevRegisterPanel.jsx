...
export default function DevRegisterPanel() {
    ...
    return (
        <div className='rounded-2xl border border-dashed border-amber-300 bg-amber-50/60 p-4'>
            ...
            >
                <div>
                    <p className='text-sm font-semibold text-amber-800'>Herramientas de desarrollo</p>
                    <p className='mt-1 text-xs text-amber-700'>Crear administrador manualmente para pruebas</p>
                </div>
